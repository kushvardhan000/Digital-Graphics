...
const proudMomentsOpenGraph: OpenGraphData = {
  ...
  title:
    "Proud Moments by Digital Graphics | Trophy Design, Awards & Corporate Gifting",
  description:
  ...
  const awards = [
    {
      ...
      path: (
        <>
          ...
          <path
            d="M20 20 L20 15 L25 15 M80 20 L80 15 L75 15 M20 80 L20 85 L25 85 M80 80 L80 85 L75 85"
            stroke="currentColor"
            strokeWidth="1.5"
          />
          ...
          {/* Outlined Cup */}
          <path
            d="M30 25 H70 V40 C70 51 61 58 50 58 C39 58 30 51 30 40 Z"
            stroke="currentColor"
            strokeWidth="1.5"
          />
          ...
          {/* Handles */}
          <path
            d="M30 32 C18 32 18 22 30 22 M70 32 C82 32 82 22 70 22"
            stroke="currentColor"
            strokeWidth="1.5"
          />
          ...
          <path
            d="M50 32 L52 38 L58 39 L53 43 L55 49 L50 46 L45 49 L47 43 L42 39 L48 38 Z"
            fill="#F59E0B"
            stroke="none"
          />
      ...
      className:
        "top-[10%] left-[5%] md:left-[15%] w-24 h-24 md:w-32 md:h-32 opacity-60",
      delay: 0.2,
    },
    {
      id: "target",
      ...
      path: (
        <>
          ...
          {/* Floating Solid Star */}
          <path
            d="M85 18 L87 23 L92 24 L88 28 L89 33 L85 30 L81 33 L82 28 L78 24 L83 23 Z"
            fill="#F59E0B"
            stroke="none"
          />
        </>
      ...
      className:
        "hidden md:block bottom-[22%] right-[5%] md:right-[15%] w-24 h-24 md:w-32 md:h-32 opacity-60",
      delay: 0.4,
    },
    {
      id: "medal",
      ...
      path: (
        <>
          ...
          />
          <path
            d="M75 22 C75 20 72 20 72 22 C72 24 75 27 75 27 C75 27 78 24 78 22 C78 20 75 20 75 22 Z"
            fill="#EF4444"
            stroke="none"
          />
          <path
            d="M70 31 L75 37 L78 31"
            stroke="currentColor"
            strokeWidth="1.5"
          ...
          {/* Solid Ribbon Top */}
          <path
            d="M35 25 L65 25 L60 50 L40 50 Z"
            fill="currentColor"
            stroke="none"
          />
          ...
          <path
            d="M25 30 L35 25 L40 50 L30 55 Z"
            stroke="#3B82F6"
            strokeWidth="1.5"
          />
          <path
            d="M75 30 L65 25 L60 50 L70 55 Z"
            stroke="#3B82F6"
            strokeWidth="1.5"
          />
          ...
          {/* Solid Star Center */}
          <path
            d="M50 56 L52 61 L58 62 L53 66 L55 72 L50 69 L45 72 L47 66 L42 62 L48 61 Z"
            fill="#F59E0B"
            stroke="none"
          />
        </>
      ...
      className:
        "top-[10%] right-[5%] md:right-[15%] w-20 h-20 md:w-28 md:h-28 opacity-60",
      delay: 0.6,
    },
    {
      id: "plaque",
      ...
      path: (
        <>
          ...
          {/* Colored Text Lines */}
          <path
            d="M35 38 H65 M35 48 H55 M35 58 H50"
            stroke="#3B82F6"
            strokeWidth="2.5"
            strokeLinecap="round"
          />
      ...
      className:
        "bottom-[27%] left-[5%] md:left-[15%] w-20 h-20 md:w-28 md:h-28 opacity-60 hidden sm:block",
      delay: 0.8,
    },
  ]
        ...
        >
          ...
          >
            <svg
              viewBox="0 0 100 100"
              fill="none"
              className="h-full w-full text-neutral-800 dark:text-neutral-200"
            >
              {award.path}
            </svg>
          </motion.div>
...
function AwardsHero() {
  ...
  return (
    <section
      ...
      className="relative flex min-h-[80svh] w-full items-start justify-center overflow-hidden bg-[#FCFCFC] px-4 pt-28 pb-10 font-sans selection:bg-blue-600/30 md:px-8 lg:items-center lg:pt-32 dark:bg-[#070707]"
    >
      {/* Background Texture: Subtle Grain */}
      <div
        className="pointer-events-none absolute inset-0 z-50 opacity-[0.03] mix-blend-difference dark:opacity-[0.02]"
        style={{
      ...
      <div className="pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] [mask-image:radial-gradient(ellipse_80%_80%_at_50%_50%,#000_20%,transparent_100%)] bg-[size:3rem_3rem]" />
      ...
      <motion.div
        ...
        className="pointer-events-none absolute inset-0 z-0 flex flex-col justify-between overflow-hidden py-10 opacity-40 dark:opacity-20"
      >
        {["2022", "2023", "2024", "2025"].map((year, i) => (
          <motion.div
            ...
            className="text-center text-[18vw] leading-[0.8] font-bold tracking-tighter text-transparent"
            style={{
      ...
      <motion.div
        ...
        className="relative z-30 mx-auto mt-6 flex w-full max-w-5xl flex-col items-center justify-center px-2 text-center md:mt-0"
      >
        {/* Eyebrow */}
        <motion.div
          ...
          className="mb-6 flex items-center justify-center gap-3 md:mb-8 md:gap-4"
        >
          <div className="h-[1px] w-6 bg-neutral-300 md:w-12 dark:bg-neutral-700" />
          <span className="font-mono text-[11px] tracking-[0.3em] text-neutral-500 uppercase md:text-xs">
            The Digital Gallery
          </span>
          <div className="h-[1px] w-6 bg-neutral-300 md:w-12 dark:bg-neutral-700" />
        </motion.div>
        ...
        <h1 className="mb-5 flex w-full flex-col items-center text-5xl leading-[1.1] font-medium tracking-tight text-neutral-900 sm:text-6xl md:mb-7 md:text-7xl lg:text-8xl dark:text-white">
          <motion.span
          ...
          <div className="relative my-3 flex h-[1.1em] w-full justify-center overflow-visible">
            <AnimatePresence>
              <motion.span
                key={WORDS[currentWordIndex]}
                className="absolute bg-[linear-gradient(110deg,#7A5C22_0%,#997A36_35%,#D1BA84_50%,#997A36_65%,#7A5C22_100%)] bg-clip-text pr-[0.15em] pl-[0.05em] text-center font-serif text-transparent lowercase italic will-change-transform dark:bg-[linear-gradient(110deg,#C99C47_0%,#E9D39B_35%,#FFF6DE_50%,#D8B86D_65%,#8F6B24_100%)]"
        ...
        <motion.p
          ...
          className="mb-16 max-w-2xl px-4 text-base leading-relaxed font-light text-neutral-600 md:text-lg lg:text-xl dark:text-neutral-400"
        >
          At Digital Graphics, we understand the power of appreciation. That's
          why we've launched{" "}
          <strong className="font-medium text-neutral-800 dark:text-neutral-200">
            Proud Moment by Digital Graphics
          </strong>{" "}
          — a brand dedicated to celebrating achievements with meaningful
          design.
        </motion.p>
      </motion.div>
    </section>
...
const SvgDesign: React.FC<SvgProps> = ({ accent }) => (
  <svg
    viewBox="0 0 400 400"
    className="h-full w-full max-w-[280px] text-neutral-900 md:max-w-[380px] dark:text-white"
    fill="none"
  >
    {" "}
    ...
    >
      ...
      <line
        ...
        strokeLinecap="round"
      />{" "}
      <circle cx="315" cy="75" r="8" fill="currentColor" />{" "}
    </motion.g>{" "}
    <motion.g
      animate={{ y: [4, -4, 4] }}
    ...
    >
      {" "}
      <circle cx="80" cy="100" r="16" stroke={accent} strokeWidth="3" />{" "}
      <path
        d="M 60 80 L 70 90 M 100 80 L 90 90"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />{" "}
    ...
    {/* Sleek Desk & Monitor */}{" "}
    <path
      d="M 40 320 L 360 320"
      stroke="currentColor"
      strokeWidth="4"
      strokeLinecap="round"
    />{" "}
    <path
      d="M 90 320 L 130 250 M 190 320 L 150 250"
      stroke="currentColor"
      strokeWidth="3"
      strokeLinecap="round"
    />{" "}
    <rect
      ...
      strokeWidth="3"
    />{" "}
    <path d="M 70 200 L 230 200" stroke="currentColor" strokeWidth="2" />{" "}
    {/* Abstract Trophy on Screen */}{" "}
    <path
      d="M 120 150 L 180 150 L 165 180 L 135 180 Z"
      stroke={accent}
      strokeWidth="3"
      strokeLinejoin="round"
    />{" "}
    <line
      ...
      strokeLinecap="round"
    />{" "}
    {/* Modern Character Design (Soft rounded features, bold strokes) */}{" "}
    <g
      stroke="currentColor"
      strokeWidth="3"
      strokeLinecap="round"
    ...
    >
      {" "}
      <circle cx="280" cy="170" r="22" /> {/* Top knot/Hair detail */}{" "}
      <circle cx="305" cy="150" r="8" fill="currentColor" />{" "}
      <path d="M 240 320 C 240 240, 260 220, 280 220 C 300 220, 320 240, 320 320" />{" "}
      {/* Dynamic Arm reaching to stylus */}{" "}
      <path d="M 270 240 C 240 260, 210 270, 180 280" />{" "}
    </g>{" "}
    {/* Stylus/Pen */}{" "}
    <line
      x1="150"
...
export const SvgTrophy = ({ accent }: { accent: string }) => (
  <svg
    viewBox="0 0 400 400"
    className="h-full w-full max-w-[280px] text-neutral-900 md:max-w-[360px] lg:max-w-[420px] dark:text-white"
    fill="none"
  ...
  >
    ...
    />
    <path
      d="M 10 25 L 25 10 M 390 25 L 375 10 M 10 375 L 25 390 M 390 375 L 375 390"
      stroke="currentColor"
      strokeWidth="1.5"
    />
    ...
    >
      <path
        d="M 230 40 Q 230 55 245 55 Q 230 55 230 70 Q 230 55 215 55 Q 230 55 230 40 Z"
        fill={accent}
      />
      <path
        d="M 120 140 Q 120 148 128 148 Q 120 148 120 156 Q 120 148 112 148 Q 120 148 120 140 Z"
        fill="currentColor"
      />
    </motion.g>
    ...
    >
      ...
      <path
        d="M 160 178 C 145 178, 135 190, 138 210 C 140 225, 150 230, 160 230 C 180 230, 185 200, 160 178"
        fill="currentColor"
      />
      <circle
        cx="155"
    ...
    >
      {/* Hologram base rays */}
      <path
        d="M 260 290 L 230 200 M 260 290 L 260 190 M 260 290 L 290 200"
        stroke={accent}
        strokeWidth="1"
        strokeDasharray="4 4"
        opacity="0.6"
      ...
      <polygon
        points="220,130 300,130 280,180 240,180"
        fill={accent}
        opacity="0.1"
        stroke={accent}
        strokeWidth="1.5"
      ...
      />
      <path
        d="M 240 180 L 260 210 L 280 180"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <polygon
        points="245,210 275,210 285,225 235,225"
        fill="currentColor"
        opacity="0.1"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      {/* Star on trophy */}
      <path
        d="M 260 145 L 263 152 L 270 152 L 264 157 L 266 164 L 260 160 L 254 164 L 256 157 L 250 152 L 257 152 Z"
        stroke={accent}
        strokeWidth="1"
        fill="none"
        strokeLinejoin="round"
...
export const SvgCrystal = ({ accent }: { accent: string }) => (
  ...
  >
    ...
    />
    <path
      d="M 15 30 L 30 15 M 385 30 L 370 15 M 15 370 L 30 385 M 385 370 L 370 385"
      stroke="currentColor"
      strokeWidth="1.5"
    />
    ...
    >
      ...
      <path
        d="M 80 250 L 95 250 M 87.5 242.5 L 87.5 257.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
    ...
    >
      <path
        d="M 120 70 Q 120 90 140 90 Q 120 90 120 110 Q 120 90 100 90 Q 120 90 120 70 Z"
        fill={accent}
      />
      <path
    ...
    >
      ...
      {/* Abstract sleek body */}
      <path
        d="M 130 400 C 130 350, 160 325, 200 325 C 240 325, 270 350, 270 400"
        fill="currentColor"
        opacity="0.05"
      />
    ...
    >
      ...
      <polygon
        points="200,80 250,140 230,220 170,220 150,140"
        fill="currentColor"
        opacity="0.8"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      <polygon
        points="200,80 200,160 250,140"
        fill="var(--bg, white)"
        opacity="0.2"
      />
      <polygon
        points="150,140 200,160 170,220"
        fill="var(--bg, white)"
        opacity="0.1"
      />
      <polygon points="250,140 200,160 230,220" fill={accent} opacity="0.6" />
      <polygon
        points="170,220 200,160 230,220"
        fill="currentColor"
        opacity="0.9"
      />
      ...
      {/* Edge Highlights */}
      <path
        d="M 200 80 L 200 160 M 150 140 L 200 160 M 250 140 L 200 160 M 170 220 L 200 160 M 230 220 L 200 160"
        stroke="var(--bg, white)"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
export const SvgMedal = ({ accent }: { accent: string }) => (
  ...
  >
    ...
    <path
      d="M 15 40 L 40 15 L 360 15 L 385 40 L 385 360 L 360 385 L 40 385 L 15 360 Z"
      stroke="currentColor"
      strokeWidth="1.5"
    />
    <path
      d="M 25 50 L 50 25 M 375 50 L 350 25 M 25 350 L 50 375 M 375 350 L 350 375"
      stroke="currentColor"
      strokeWidth="1"
      opacity="0.3"
    />
    ...
    >
      <path
        d="M 50 120 C 100 80, 200 70, 350 130"
        stroke="currentColor"
        strokeWidth="1"
        strokeDasharray="4 6"
        opacity="0.5"
      ...
      <path
        d="M 320 200 L 330 210 M 330 200 L 320 210"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
    ...
    >
      <path
        d="M 280 180 h 40 a 10 10 0 0 1 10 10 v 20 a 10 10 0 0 1 -10 10 h -25 l -10 10 v -10 h -5 a 10 10 0 0 1 -10 -10 v -20 a 10 10 0 0 1 10 -10 z"
        fill="var(--bg, transparent)"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      ...
      <path
        d="M 293 195 C 293 190, 300 190, 300 195 C 300 190, 307 190, 307 195 C 307 202, 300 208, 300 208 C 300 208, 293 202, 293 195 Z"
        fill={accent}
      />
    </motion.g>
    ...
    >
      <path
        d="M 60 220 h 40 a 10 10 0 0 1 10 10 v 20 a 10 10 0 0 1 -10 10 h -5 v 10 l -10 -10 h -25 a 10 10 0 0 1 -10 -10 v -20 a 10 10 0 0 1 10 -10 z"
        fill="currentColor"
        opacity="0.05"
        stroke="currentColor"
        strokeWidth="1.5"
    ...
    >
      ...
      <path
        d="M 130 400 C 130 330, 160 300, 200 300 C 240 300, 270 330, 270 400"
        fill="var(--bg, transparent)"
      />
    ...
    >
      {/* Crisp Ribbon */}
      <path
        d="M 130 60 L 200 150 M 270 60 L 200 150"
        stroke={accent}
        strokeWidth="24"
      ...
      />
      <path
        d="M 140 60 L 200 150 M 260 60 L 200 150"
        stroke={accent}
        strokeWidth="8"
        strokeLinecap="square"
      />
      ...
      {/* Center Star/Icon */}
      <path
        d="M 200 148 L 206 162 L 220 164 L 210 174 L 212 188 L 200 182 L 188 188 L 190 174 L 180 164 L 194 162 Z"
        fill={accent}
        stroke={accent}
        strokeWidth="1.5"
        strokeLinejoin="round"
      ...
      <path
        d="M 255 125 Q 260 130 265 130 Q 260 130 260 135 Q 260 130 255 130 Q 260 130 255 125 Z"
        fill="currentColor"
      />
      <path
        d="M 140 180 Q 145 185 150 185 Q 145 185 145 190 Q 145 185 140 185 Q 145 185 140 180 Z"
        fill={accent}
      />
    </motion.g>
  </svg>
...
export const SvgMemento = ({ accent }: { accent: string }) => (
  ...
  >
    ...
    >
      ...
      <path
        d="M 170 120 L 230 120 L 230 265 L 170 265 Z"
        fill="currentColor"
        opacity="0.05"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      {/* 3D Depth Lines */}
      <path
        d="M 230 120 L 245 105 L 245 250 L 230 265"
        fill={accent}
        opacity="0.1"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      />
      <path
        d="M 170 120 L 185 105 L 245 105"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      ...
      <path
        d="M 155 125 Q 165 130 175 130 Q 165 130 165 140 Q 165 130 155 130 Q 165 130 155 125 Z"
        fill="currentColor"
      />
    </motion.g>
    ...
    >
      <path
        d="M 80 120 L 120 80 M 280 80 L 320 120"
        stroke="currentColor"
        strokeWidth="1"
        strokeDasharray="3 3"
        strokeLinecap="round"
      ...
      />
      <path
        d="M 290 150 L 320 150 M 298 137 L 298 143 M 312 137 L 312 143"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
    ...
    >
      ...
      <path
        d="M 50 340 C 50 270, 80 250, 110 250 C 130 250, 145 260, 155 280"
        fill="var(--bg, transparent)"
      />
      ...
      <path
        d="M 350 340 C 350 270, 320 250, 290 250 C 270 250, 255 260, 245 280"
        fill="var(--bg, transparent)"
      />
      ...
      <path
        d="M 185 285 L 200 270 L 215 285"
        stroke={accent}
        strokeWidth="4"
        fill="none"
...
export const SvgGift = ({ accent }: { accent: string }) => (
  ...
  >
    ...
    >
      ...
      <path
        d="M 250 60 h 50 a 10 10 0 0 1 10 10 v 20 a 10 10 0 0 1 -10 10 h -35 l -10 10 v -10 h -5 a 10 10 0 0 1 -10 -10 v -20 a 10 10 0 0 1 10 -10 z"
        fill="currentColor"
        opacity="0.05"
        stroke="currentColor"
        strokeWidth="1.5"
    ...
    >
      <path
        d="M 120 140 Q 130 145 140 145 Q 130 145 130 155 Q 130 145 120 145 Q 130 145 120 140 Z"
        fill="currentColor"
      />
      <circle
        cx="280"
    ...
    >
      ...
      {/* Suit/Blazer */}
      <path
        d="M 120 340 C 120 250, 160 210, 200 210 C 240 210, 280 250, 280 340"
        fill="var(--bg, transparent)"
      />
    ...
    >
      ...
      {/* Box Lid */}
      <polygon
        points="140,250 200,225 260,250 200,275"
        fill="currentColor"
        opacity="0.9"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      <polygon
        points="145,260 198,282 198,330 145,308"
        fill="currentColor"
        opacity="0.1"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      />
      <polygon
        points="255,260 202,282 202,330 255,308"
        fill="var(--bg, transparent)"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M 172 250 L 172 320"
        stroke={accent}
        strokeWidth="2"
        opacity="0.5"
      />
      <path
        d="M 228 250 L 228 320"
        stroke={accent}
        strokeWidth="2"
        opacity="0.5"
      />
      ...
      {/* Ribbon Crossing Lid */}
      <path
        d="M 160 242 L 240 275 M 240 242 L 160 275"
        stroke={accent}
        strokeWidth="2"
      />
      ...
      {/* Elegant Ribbon Bow */}
      <path
        d="M 200 240 C 170 210, 150 230, 200 250 C 250 230, 230 210, 200 240 Z"
        fill={accent}
        stroke={accent}
        strokeWidth="1.5"
        strokeLinejoin="round"
...
const WhyChooseUs: React.FC<WhyChooseUsProps> = ({
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white py-16 text-neutral-900 md:py-24 dark:bg-neutral-950 dark:text-white">
      {/* Container */}
      <div className="relative z-10 mx-auto max-w-[1440px] px-6 md:px-12">
        {/* UPPER PART: Enhanced Editorial Header */}
        <div className="relative border-b border-neutral-200 pb-12 md:pb-20 dark:border-neutral-800">
          {/* Abstract Animated Geometry in Background of Header */}
          <div className="pointer-events-none absolute top-0 right-0 h-64 w-64 overflow-hidden opacity-5 md:h-96 md:w-96 dark:opacity-10">
            <motion.svg
              viewBox="0 0 100 100"
          ...
          <motion.div
            ...
            variants={stagger}
            className="relative z-10 flex flex-col justify-between gap-10 lg:flex-row lg:items-end"
          >
            {/* Title Area */}
            <div className="max-w-3xl">
              ...
              >
                ...
                <span className="text-[10px] font-semibold tracking-[0.25em] text-neutral-500 uppercase md:text-xs">
                  The Proud Moment
                </span>
              </motion.div>
              ...
              <motion.h2
                variants={fadeUp}
                className="text-4xl leading-[1.1] font-light tracking-tighter md:text-5xl lg:text-7xl"
              >
                Why Choose <br className="hidden md:block" />
                <span
                  className="pr-2 font-medium italic"
                  style={{ color: accent }}
                >
                  Digital Graphics?
                </span>
            ...
            <motion.div variants={fadeUp} className="max-w-md lg:w-[400px]">
              <div className="relative pl-6 before:absolute before:top-2 before:bottom-2 before:left-0 before:w-[2px] before:bg-neutral-200 dark:before:bg-neutral-800">
                <div
                  className="bg-currentColor absolute top-2 left-0 h-8 w-[2px]"
                  style={{ backgroundColor: accent }}
                />
                <p className="text-base leading-relaxed font-light text-neutral-600 md:text-lg dark:text-neutral-400">
                  We believe every achievement deserves more than a generic
                  token. We ensure every piece carries
                  <strong className="font-medium text-neutral-900 dark:text-white">
                    {" "}
                    emotional and brand value
                  </strong>
                  , whether it's a grand ceremony or a quiet moment of
                  gratitude.
                </p>
              </div>
            </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-50px" }}
          variants={stagger}
          className="grid grid-cols-1 gap-0 border-b border-neutral-200 md:grid-cols-3 dark:border-neutral-800"
        >
          {/* Feature 01 */}
          <motion.div
            variants={fadeUp}
            className="group relative flex flex-row gap-5 border-b border-neutral-200 p-6 transition-colors hover:bg-neutral-50 md:flex-col md:gap-6 md:border-r md:border-b-0 md:p-8 lg:p-10 dark:border-neutral-800 dark:hover:bg-neutral-900/30"
          >
            <div className="group-hover:border-currentColor flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-neutral-200 bg-white transition-colors dark:border-neutral-800 dark:bg-neutral-950">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            <div>
              <div className="mb-2 flex items-center gap-3">
                ...
                <h3
                  className="group-hover:text-currentColor text-lg font-medium tracking-tight transition-colors md:text-xl"
                  style={{ color: accent }}
                >
                  Thoughtful Design
                </h3>
              </div>
              <p className="text-sm leading-relaxed font-light text-neutral-500 md:text-base dark:text-neutral-400">
                Moving beyond standard templates to create architectural forms
                that elevate recognition into an art piece.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed font-light text-neutral-500 md:text-base dark:text-neutral-400">
                Meticulously crafted from the highest grade materials, ensuring
                the tactile weight matches its visual presence.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            variants={fadeUp}
            className="group relative flex flex-row gap-5 p-6 transition-colors hover:bg-neutral-50 md:flex-col md:gap-6 md:p-8 lg:p-10 dark:hover:bg-neutral-900/30"
          >
            <div className="group-hover:border-currentColor flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-neutral-200 bg-white transition-colors dark:border-neutral-800 dark:bg-neutral-950">
              <svg
                width="20"
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed font-light text-neutral-500 md:text-base dark:text-neutral-400">
                Seamlessly integrating your brand's identity into the physical
                piece, keeping recognition deeply connected.
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        <div className="relative z-10 flex w-1/2 flex-col bg-stone-50 dark:bg-zinc-950">
          {CHAPTERS.map((chapter, index) => (
            <div
              ...
              className="flex min-h-screen w-full flex-col justify-center px-16 lg:px-24"
            >
              <h2 className="mb-6 text-5xl leading-[1.1] font-medium tracking-tight lg:text-6xl">
                {chapter.title}
              </h2>
              ...
              {chapter.points && (
                <div className="grid grid-cols-1 gap-x-12 gap-y-4 border-t border-stone-200 pt-8 lg:grid-cols-2 dark:border-zinc-800/50">
                  {chapter.points.map((point, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-4 border-b border-stone-200/50 py-2 last:border-b-0 lg:last:border-b dark:border-zinc-800/50"
                    >
                      <svg
                        width="16"
                        height="16"
...
export default function ProudMoments() {
  ...
  return (
    <div className="relative w-full bg-stone-50 font-sans text-neutral-900 dark:bg-zinc-950 dark:text-zinc-50">
      <SEO
        title="Proud Moments"
